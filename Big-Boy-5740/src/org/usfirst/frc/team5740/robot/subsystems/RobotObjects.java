...
public class RobotObjects {
	...
	public static DoubleSolenoid solenoid0 = new DoubleSolenoid(0, 1);
	public static DoubleSolenoid solenoid1 = new DoubleSolenoid(2, 3);
	public static DoubleSolenoid solenoid2 = new DoubleSolenoid(4, 5);
	public static DoubleSolenoid solenoid3 = new DoubleSolenoid(6, 7);
